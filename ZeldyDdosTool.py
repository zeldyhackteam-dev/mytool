...
try:
   ...
   init(autoreset=True) # Otomatik sıfırlama eklendi
except ImportError:
    os.system("pip install colorama")
    from colorama import Fore, init
    init(autoreset=True)

# --- Shadowbyte'ın eklediği prompt fonksiyonu ---
def prompt(text):
...
global ua
ua = ['Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Safari/537.36', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:57.0) Gecko/20100101 Firefox/57.0', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_2) AppleWebKit/604.4.7 (KHTML, like Gecko) Version/11.0.2 Safari/604.4.7', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:57.0) Gecko/20100101 Firefox/57.0']
...
try:
    # Prompt fonksiyonu burada devreye giriyor
    raw_input = prompt("IP or URL Target :")
    port = int(prompt("Port :"))
    bost = prompt("Boost (Y/N) :").lower()
